...
const spritePaths = {
  [IconType.STROKE]: '/src/assets/svg/tabler-sprite-outline.svg',
  [IconType.FILL]: '/src/assets/svg/tabler-sprite-fill.svg',
  [IconType.CUSTOM]: '/src/assets/svg/sprite-custom.svg'
};
